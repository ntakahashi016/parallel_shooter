...
func (ef *Boss1Factory) NewBoss1(x,y int, p Phase, c Commander) *Character {
	o := Object{game:ef.game, point: NewPoint(float64(x),float64(y)), height:BOSS1HEIGHT, width:BOSS1WIDTH, phase: p, images: &ef.imageSet}
